...
# Score
lower.score <- (y.bar + qnorm(p = 1 - alpha/2)/(2*n)) - qnorm(p = 1 - alpha/2) * sqrt((y.bar + qnorm(p = 1 - alpha/2)/(4*n))/n) 
upper.score <- (y.bar + qnorm(p = 1 - alpha/2)/(2*n)) + qnorm(p = 1 - alpha/2) * sqrt((y.bar + qnorm(p = 1 - alpha/2)/(4*n))/n) 
